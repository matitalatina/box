...
import japgolly.scalajs.react.{Ref, ReactComponentU, ReactComponentB, BackendScope}
...
object Debug {
    ...
    type DebugComponent = ReactComponentU[Unit,Option[js.Any],Backend,react.TopNode]
