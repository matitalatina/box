...
import ch.wsl.box.model.boxentities.Conf.{Conf, Conf_row}
import ch.wsl.box.model.boxentities.Field.{Field, Field_i18n, Field_i18n_row, Field_row}
import ch.wsl.box.model.boxentities.Form.{Form, Form_row}
import ch.wsl.box.model.boxentities.Labels.{Labels, Labels_row}
import ch.wsl.box.model.boxentities.UITable.{UI, UI_row}
