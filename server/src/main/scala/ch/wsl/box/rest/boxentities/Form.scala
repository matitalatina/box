...
object Form {
  ...
  case class Form_row(form_id: Option[Int] = None, name: String, entity:String, description: Option[String] = None, layout: Option[String] = None,
                      tabularFields: Option[String] = None, query: Option[String] = None, exportView:Option[String] = None)
  ...
  class Form(_tableTag: Tag) extends profile.api.Table[Form_row](_tableTag, "form") {
    def * = (Rep.Some(form_id), name, entity, description, layout, tabularFields, query,exportView) <> (Form_row.tupled, Form_row.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(form_id), name, entity, description, layout, tabularFields, query,exportView).shaped.<>({ r=>import r._; _1.map(_=> Form_row.tupled((_1, _2, _3, _4, _5, _6, _7,_8)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
