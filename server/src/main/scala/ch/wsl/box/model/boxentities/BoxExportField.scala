...
object BoxExportField {
  ...
  case class BoxExportField_row(field_id: Option[Int] = None, export_id: Int, `type`: String, name: String, widget: Option[String] = None,
  ...
  class BoxExportField(_tableTag: Tag) extends profile.api.Table[BoxExportField_row](_tableTag,BoxSchema.schema, "export_field") {
    ...
    lazy val exportFk = foreignKey("fkey_export", export_id, BoxExport.BoxExportTable)(r => r.export_id, onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
  ...
  case class BoxExportField_i18n_row(id: Option[Int] = None, field_id: Option[Int] = None, lang: Option[String] = None, label: Option[String] = None,
  ...
  class BoxExportField_i18n(_tableTag: Tag) extends profile.api.Table[BoxExportField_i18n_row](_tableTag,BoxSchema.schema, "export_field_i18n") {
    ...
    lazy val fieldFk = foreignKey("fkey_field", field_id, BoxExportFieldTable)(r => Rep.Some(r.field_id), onUpdate=ForeignKeyAction.NoAction, onDelete=ForeignKeyAction.NoAction)
  }
